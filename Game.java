...
public class Game {
            ...
            //remove if it doesn't work
    {
        ...
        Card playedcard = new MineralCard();
        //get card with name entered
        for (int i=0; i < getHandNames(playerlist[who_turn]).size(); ++i)
        {
    ...
    {
        System.out.println(current_category + ": " + current_value);
        System.out.println("");
        displayHand(playerlist[who_turn]);
        ...
        switch(entered)
        {
            ...
            case ("play a card"):
                ...
                break;
            default:
                System.out.println("I'm sorry that wasn't clear. You can enter play, play a card, or pass.");
                askPassOrPlay();
        }
    }
            ...
            //how you end a game with a full set of winners
    {
        ...
        {
            int place = i+1;
            System.out.println(winnerlist[i].getName() + " is number " + i + "!");
        }
